...
const prep1 = new SpecItem(beerBbq,1);
const prep2 = new SpecItem(beerBatter,1);
const prep3 = new SpecItem(bbqMustardMayo,1);
const prep4 = new SpecItem(bbqBeans,1);
const prep5 = new SpecItem(beerMacNCheeseBBQ,1);
const prep6 = new SpecItem(blueCheeseMayo,1);
const prep7 = new SpecItem(croutons,1);
const prep8 = new SpecItem(cookedPulledChicken,1);
const prep9 = new SpecItem(chilliVodkaSalsa,1);
const prep10 = new SpecItem(cajunMarinatedChicken.burgers,1);
const prep11 = new SpecItem(cajunMarinatedChicken.main,1,['vegetarian','show']);
const prep12 = new SpecItem(cajunMarinatedChicken.strip,1,['vegetarian','show']);
...
const prep15 = new SpecItem(coleslaw.standard,1);
const prep16 = new SpecItem(coleslaw.ve,1);
const prep17 = new SpecItem(cookedBacon,1);
const prep18 = new SpecItem(flatBread,1);
const prep19 = new SpecItem(friedChicken.burger,1)
const prep20 = new SpecItem(friedChicken.main,1,['vegan','show'])
const prep21 = new SpecItem(friedChicken.strips,1,['vegan','show'])
const prep22 = new SpecItem(friedChickenVE.main,1,['vegan','active']);
const prep23 = new SpecItem(friedChickenVE.strips,1,['vegan','active']);
const prep24 = new SpecItem(gravy,1);
const prep25 = new SpecItem(harissaHummus,1);
const prep26 = new SpecItem(limePickleMayo,1);
const prep27 = new SpecItem(macNCheeseCrumb,1);
const prep28 = new SpecItem(roastedRedPepper,1);
const prep29 = new SpecItem(saltPepperSeasoning,1);
const prep30 = new SpecItem(srirachaMayo,1);
const prep31 = new SpecItem(truffleGravy,1);
const prep32 = new SpecItem(doughBalls,1,['vegan','show']);
const prep33 = new SpecItem(doughBallsVe,1,['vegan','active']);
const prep34 = new SpecItem(sliders.meat,1,['vegan','show'],['vegetarian','show']);
const prep35 = new SpecItem(sliders.veggie,1,['vegan','show'],['vegetarian','active']);
const prep36 = new SpecItem(sliders.vegan,1,['vegan','active'],['vegetarian','show']);
